...
<div class="container">
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('librarian.borrow.pending') }}">📙 Igények</a>
        </li>
        <li class="nav-item">
    ...
    <div class="alert alert-primary" role="alert">
        Ezeket a kölcsönzéseket még csak igény szintjén nyújtották be, el lehet fogadni, vagy el lehet utasítani őket.
    </div>
    <table class="table">
        <tbody>
