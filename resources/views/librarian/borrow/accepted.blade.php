...
<div class="container">
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('librarian.borrow.accepted') }}">✔ Elfogadva</a>
        </li>
        <li class="nav-item">
    ...
    <div class="alert alert-primary" role="alert">
        Ezeket a kölcsönzéseket a könyvtárosok már elfogadták, és ezek a könyvek jelenleg az olvasóknál vannak.
    </div>
    <table class="table">
        <tbody>
