...
<div class="container">
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('librarian.borrow.late') }}">⌛ Késés</a>
        </li>
      </ul>
      <div class="col-12 col-md-8 mb-2">
        <h3 class="mb-1">Késésben lévő könyvek</h3>
    </div>
    <div class="alert alert-primary" role="alert">
      Ezeket a kölcsönzéseket a könyvtárosok már elfogadták, és ezek a könyvek jelenleg az olvasóknál vannak, azonban nem juttatták vissza őket a könyvtárnak határidőre.
    </div>
    <table class="table">
        <tbody>
