...
<div class="container">
   @if ($lates > 0)
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('reader.borrow.accepted') }}">✔ Elfogadva</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('reader.borrow.returned') }}">📗 Visszahozva</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('reader.borrow.late') }}">⌛ Késés @if ($lates > 0)<b style="color: #c90902;">{{$lates}}</b>@endif</a>
        </li>
    </ul>
    <div class="col-12 col-md-8 mb-2">
        <h3 class="mb-1">Elfogadott kölcsönzések</h3>
    </div>
    <div class="alert alert-primary" role="alert">
        Ezek a kölcsönzések el lettek fogadva, nálad van a megigényelt könyv.
    </div>
    <table class="table">
        <tbody>
